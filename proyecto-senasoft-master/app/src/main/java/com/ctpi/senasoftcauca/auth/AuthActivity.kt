package com.ctpi.senasoftcauca.auth
...
import com.ctpi.senasoftcauca.Activity_Loggin_Huawei
import com.ctpi.senasoftcauca.push.GetTokenAction
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 1000){
            if (resultCode == Activity.RESULT_CANCELED){
                ...
                val intent = Intent(this, Activity_Loggin_Huawei::class.java)
